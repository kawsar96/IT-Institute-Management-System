...
<body class="animsition">
	...
	<header>
		...
		<div class="">
          ...
          <a href="{{route('stu.edit', $students->id)}}" class="btn btn-danger m-r-10" style="font-weight:bold ">2nd Installment</a> 
						<a href="/stu/getPDF/{{$students->id}}" class="btn btn-info" style="font-weight:bold ">Print</a>
            @else
            <a href="{{route('student.edit', $students->id)}}" class="btn btn-danger m-r-10" style="font-weight:bold ">Edit</a> 
						<a href="/student/getPDF/{{$students->id}}" class="btn btn-info" style="font-weight:bold ">Print</a>
            @endif
