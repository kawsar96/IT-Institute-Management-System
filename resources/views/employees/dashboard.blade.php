...
<table style="background-color: #212529; color: white;" class="table">
        ...
        <tr>
            ...
            <td>
                 ...
                 <form class="btn" action="/employee/destroy/{{$employee->id}}" method="post">
                 @csrf
                    @method('DELETE')
                    <button type="submit" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger">Delete</button> 
                    <a href="/employee/edit/{{$employee->id}}" class="btn btn-info">Edit</a>
                    <a href="/employee/show/{{$employee->id}}" class="btn btn-warning">Show</a> 
   ...
   <div class="t-center p-b-15">
            <a href="/employee/create" class="btn btn-lg btn-success">Register New Employee</a>
        </div>
