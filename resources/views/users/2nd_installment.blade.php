...
<button class="btn col-lg-3 btn-danger my-2 indv_btn"><a class="linked btn-lg btn-block" onclick="return confirm('Are you sure you want to clear this item?');" href="/clear2">Clear All Approved Notifications</a></button>
...
<table class="table tabel-bordered table-dark">
        ...
        <tr>
            ...
            <td>{{$student->notice2}}</td>
            <td>

            <div class="btn">           
                    <a href="{{route('student.show', $student->id)}}" class="btn btn-info">Show</a>
                    @if ($student->is_approved2 == '1')
                    <a href="{{route('post.approve2', $student->id)}}" class="btn btn-warning">Pending</a>
                    @elseif ($student->is_approved2 == '2')
