...
<link rel="icon" href="/images/title.png">
	<title>Part-time Employee Profile</title>
	<meta charset="UTF-8">
			...
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					...
					<div class="social flex-w flex-l-m p-r-20">
						<a href="/parttimeadmin/getPDF/{{$employees->id}}" class="btn-danger p-t-5 p-b-5 p-l-20 p-r-20">Print</a>
...
<button class="btn col-lg-2 offset-lg-5 btn-danger my-2 btn-lg"><a class="linked btn-lg" href="/parttimeadmin/p-e.dashboard">Return Back</a></button>
</div> 
